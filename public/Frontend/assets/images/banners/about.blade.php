...
@section('content')
    ...
    <div class="container-fluid about-section position-relative">
        ...
        <div class="row">
            <div class="col-12 p-0">
                <img src="" alt="About Us Banner" class="img-fluid about-image">
            </div>
        </div>
    ...
    <section  class="container-fluid">
        <div class="row p-4">
            <!-- Sidebar Column -->
            <div class="col-lg-3 order-lg-last d-none d-lg-block" dir="rtl">
            ...
            <div class="col-lg-9">
                ...
                <div id="production" class="row m-4 mb-3 mb-lg-5">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="section-title" style="direction: rtl;">إنتاجنا</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 production-lines" style="direction: rtl;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-12 d-flex flex-column production-capacity h-100 justify-content-center" style="direction: rtl;">
                ...
                <div id="history" class="row m-4 mb-3 mb-lg-5" dir="rtl">
                    ...
                    <!-- Suppliers Section -->
                    <div id="suppliers" class="row m-4 mb-3 mb-lg-5" dir="rtl">
                        <div class="col-lg-12">
                            <div class="row">
                    ...
                    <!-- Why Us Section -->
                    <div id="whyUs" class="row m-4 mb-3 mb-lg-5" dir="rtl">
                    ...
                    <div id="responsibility" class="row m-4 align-items-center mb-3 mb-lg-5 mt-lg-5" dir="rtl">
                        <!-- Image Slider -->
