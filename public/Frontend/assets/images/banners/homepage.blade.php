    ...
    <div class="row g-0">
        ...
        <div class="col-lg-5 col-md-5 p-0 position-relative d-flex align-items-center justify-content-center">
            ...
            <div class="position-absolute text-container text-right">
                ...
                <button class="btn btn-success btn-custom" dir="rtl">اطلب مطبخك!</button>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="videoModalLabel">عن أوبوليا</h5>
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-none d-md-block">
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column" >
                    <img src="Frontend/assets/images/gallery/White.png" class="image-small mb-3" alt="Gold Kitchen Design">
                    <img src="Frontend/assets/images/gallery/Gold.png" class="image-large" alt="White Kitchen Design">
                </div>

                <!-- Right Column -->
                <div class="col-md-6 d-flex flex-column">
                    <img src="Frontend/assets/images/gallery/Brown.png" class="image-large mb-3" alt="Brown Kitchen Design">
                    <img src="Frontend/assets/images/gallery/Red.png" class="image-small" alt="Red Kitchen Design">
                </div>
            </div>
        </div>
        ...
        <div class="col-12 d-md-none">
            <div class="new-arrivals owl-carousel owl-theme">
                <div class="item">
                    <img src="Frontend/assets/images/gallery/White.png" class="img-fluid image-slider" alt="Gold Kitchen Design" style="height: 200px">
                </div>
                <div class="item">
                    <img src="Frontend/assets/images/gallery/Gold.png" class="img-fluid image-slider" alt="White Kitchen Design" style="height: 200px">
                </div>
                <div class="item">
                    <img src="Frontend/assets/images/gallery/Brown.png" class="img-fluid image-slider" alt="Brown Kitchen Design" style="height: 200px">
                </div>
                <div class="item">
                    <img src="Frontend/assets/images/gallery/Red.png" class="img-fluid image-slider" alt="Red Kitchen Design" style="height: 200px">
                </div>
            </div>
        </div>
    ...
    <div class="container text-center">
        ...
        <div class="row g-4 d-flex justify-content-center" style="direction: rtl;">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/measurement.png" class="card-icon mb-3" alt="تصاميم مميزة">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/ribbon.png" class="card-icon mb-3" alt="جودة عالية">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend\assets\images\icons\headphones.png" class="card-icon mb-3"
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/Discount.png" class="card-icon mb-3" alt="أسعار تنافسية">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/garuntee.png" class="card-icon mb-3" alt="الضمان">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/date.png" class="card-icon mb-3" alt="الالتزام بالمواعيد">
            ...
            <div class="col-md-3 col-sm-6 d-flex">
                <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    <img src="Frontend/assets/images/icons/delivery.png" class="card-icon mb-3" alt="توصيل مريح">
            ...
            <div class="card text-center shadow p-4 d-flex flex-column align-items-center justify-content-between w-100 h-100">
                    ...
                    <img src="Frontend/assets/images/icons/staff.png" class="card-icon mb-3" alt="سهولة التواصل">
    ...
    <div class="container text-center" style="direction: rtl">
        ...
        <div class="row g-4 mt-4 justify-content-center">
            ...
            <div class="col-md-3 col-sm-6 d-flex flex-column align-items-center">
                <img src="Frontend/assets/images/gallery/NewClassic.webp" class="img-fluid rounded shadow"
            ...
            <!-- Card 2 -->
            <div class="col-md-3 col-sm-6 d-flex flex-column align-items-center">
                <img src="Frontend/assets/images/gallery/Modern.webp" class="img-fluid rounded shadow"
                    alt="مطابخ حديثة">
            ...
            <!-- Card 3 -->
            <div class="col-md-3 col-sm-6 d-flex flex-column align-items-center">
                <img src="Frontend/assets/images/gallery/L-Shaped.webp" class="img-fluid rounded shadow"
                    alt="مطابخ على شكل L">
            ...
            <!-- Card 4 -->
            <div class="col-md-3 col-sm-6 d-flex flex-column align-items-center">
                <img src="Frontend/assets/images/gallery/U-Shaped.webp" class="img-fluid rounded shadow"
            ...
            <div id="germanQualitySlider" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="Frontend/assets/images/gallery/01.png" class="d-block w-100 rounded-4"
                            alt="German Quality Kitchen">
                    </div>
                    <div class="carousel-item">
                        <img src="Frontend/assets/images/gallery/02.png" class="d-block w-100 rounded-4"
                            alt="Luxury Kitchen">
                    </div>
                    <div class="carousel-item">
                        <img src="Frontend/assets/images/gallery/03.png" class="d-block w-100 rounded-4"
                            alt="Modern Kitchen">
                    </div>
                    <div class="carousel-item">
                        <img src="Frontend/assets/images/gallery/04.png" class="d-block w-100 rounded-4"
                            alt="Modern Kitchen">
                    </div>
                </div>
...
<section class="container text-center p-5">
    <h2 class="fw-bold text-success" style="direction: rtl;">مصممو اوبوليا اون لاين!</h2>
    <p class="mt-3 designers-text" style="direction: rtl;">
    ...
    <p class="be-a-designer" style="direction: rtl;"> انضم الآن وكن جزء من فريق التصميم</p>

    <!-- Designers Owl Carousel -->
    <div class="new-arrivals owl-carousel owl-rtl d-flex justify-content-center owl-theme designers-carousel position-relative align-content-center mt-5">
...
function showPortfolioImage(imageSrc) {
    ...
    <div class="text-center mt-4">
        <a href="#" class="btn btn-success">مشاهدة الكل</a>
    </div>
</section>
