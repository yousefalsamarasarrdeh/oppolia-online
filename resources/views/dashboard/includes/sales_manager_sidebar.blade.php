            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('admin.users.index.main') }}">
                        <i class="bi bi-circle text-black"></i><span class="dashboard-title">عرض جميع المستخدمين</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.designers.index')}}">
                        <i class="bi bi-circle text-black"></i><span class="dashboard-title">عرض المصممين</span>
                    </a>
                </li>
            </ul>
