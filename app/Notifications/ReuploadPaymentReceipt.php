...
class ReuploadPaymentReceipt extends Notification
{
    use Queueable;
    ...
    public function __construct($installment, $order, $customMessage = null)
    {
        ...
        $this->order = $order;
        $this->customMessage = $customMessage ?? 'يرجى إعادة رفع إيصال الدفع للدفعة رقم ' . $this->installment->installment_number . ' للطلب رقم ' . $this->order->id;
    }
